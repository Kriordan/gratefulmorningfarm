...
ROOT_URLCONF = "gratefulmorningfarm.config.urls"
# https://docs.djangoproject.com/en/dev/ref/settings/#wsgi-application
WSGI_APPLICATION = "gratefulmorningfarm.config.wsgi.application"
...
LOCAL_APPS = [
    ...
    "gratefulmorningfarm.user",
    "gratefulmorningfarm.util",
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "builtins": [
                ...
                "gratefulmorningfarm.util.templatetags.filters",
            ],
...
COMPONENTS = {
    ...
    "libraries": [
        "gratefulmorningfarm.util.components",
    ],
}
...
def prefixed_cookie(name):
    return f"gratefulmorningfarm_{name}"
...
ACCOUNT_FORMS = {
    "login": "gratefulmorningfarm.user.forms.LoginForm",
    "signup": "gratefulmorningfarm.user.forms.SignupForm",
}
